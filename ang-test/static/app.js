...
if ( ! Detector.webgl ) Detector.addGetWebGLMessage();
  ...
  var mouse2D, mouse3D, raycaster, rollOveredFace, isShiftDown = false, theta = 45 * 0.5, isCtrlDown = false;
...
function on_ready(){// Called when the page is fully loaded/rendered
    // Make sure any rogue console.logs won't mess anything up.
    if (!window.console) window.console = {};
    if (!window.console.log) window.console.log = function() {};

    // Try to connect to the gat damn server
//    net.connect();
